...
Damn Vulnerable Web App (DVWA) est un site web vul\-né\-ra\-ble. Il permet aux professionnels de la sécurité de tester leurs com\-pé\-ten\-ces et leurs outils sans enfreindre la loi et aux developpeurs web de mieux comprendre les principes de sé\-cu\-ri\-sa\-tion web. C'est aussi un outil pédagogique pour les en\-sei\-gnants et les étudiants. C'est dans cet esprit que ce rapport a été rédigé.
}
