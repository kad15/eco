...
%				keepaspectratio]{image/fret.jpg\label{key}}}%
%			\vfill
%}}}
...
\input{page-de-couverture/couv}
\pagebreak

\tableofcontents
\justify
\input{intro_conclusion/introduction}

\section{Analyse de marché suivant le modèle de Porter}
\input{sections/partie_1_concurrence}
\input{sections/partie_1_clients}
\input{sections/partie_1_fournisseurs}
\input{sections/partie_1_entrants}
\input{sections/partie_1_substituts}
\input{sections/partie_2}
\input{sections/partie_3}
